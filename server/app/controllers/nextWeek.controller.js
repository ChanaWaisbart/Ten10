...
const NextWeekProducts = db.NextWeekProducts;


// Delete a product with the specified productId in the request
exports.deleteProducts = (req, res) => {
    NextWeekProducts.findOneAndRemove(req.params)
        .then(product => {
            if (!product) {
...
exports.createProducts = (req, res) => {
    ...
    // Create 
    const newProduct = new NextWeekProducts(req.body);
...
exports.readProducts = (req, res) => {
    NextWeekProducts.find(req.query)
        .then(products => {
            res.send(products)
        })
        .catch(error => {
...
exports.updateProducts = (req, res) => {
    ...
    NextWeekProducts.findOneAndUpdate(req.params, req.body
        , { new: true })
        .then(products => {
            if (!products) {
                return res.status(404).send({
